...
private final class IAyuAppearanceArguments {
    ...
    init(updateDeletedBadge: @escaping (String) -> Void, updateEditedBadge: @escaping (String) -> Void, toggleShowDates: @escaping (Bool) -> Void) {
...
private enum IAyuAppearanceEntry: ItemListNodeEntry {
    ...
    var section: ItemListSectionId {
        switch self {
        case .badgesHeader, .deletedBadge, .editedBadge, .badgesInfo:
    ...
    var stableId: Int32 {
        ...
        case .editHistoryHeader: return 4
        case .showDates: return 5
        }
    }
